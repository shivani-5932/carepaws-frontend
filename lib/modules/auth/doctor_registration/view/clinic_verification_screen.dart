...
class UploadClinicDocScreen extends StatefulWidget {
  const UploadClinicDocScreen({super.key});

  @override
  State<UploadClinicDocScreen> createState() => _UploadClinicDocScreenState();
}

class _UploadClinicDocScreenState extends State<UploadClinicDocScreen> {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text("Upload Clinic Documents"),
