...
class UploadVetDocumentScreen extends StatefulWidget {
  const UploadVetDocumentScreen({super.key});

  @override
  State<UploadVetDocumentScreen> createState() => _UploadVetDocumentScreenState();
}

class _UploadVetDocumentScreenState extends State<UploadVetDocumentScreen> {
